		...
		Wt = (e, n, o) => {
			...
			if (i)
				if ((i.stopKeydownPropagation && n.stopPropagation(), 'Enter' === n.key))
					(e = e), (a = n), (t = i), w(t.allowEnterKey) && !a.isComposing && a.target && e.getInput() && a.target.outerHTML === e.getInput().outerHTML && (['textarea', 'file'].includes(t.input) || (Nt(), a.preventDefault()));
				else if ('Tab' !== n.key) {
